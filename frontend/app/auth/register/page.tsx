      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/20">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base text-gray-300">Créez votre compte gratuitement</p>
          </div>
          ...
          <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-white/5 rounded-lg border border-white/10">
            <p className="text-xs sm:text-sm text-gray-300 mb-2 sm:mb-3">Avec votre compte, vous bénéficiez de :</p>
